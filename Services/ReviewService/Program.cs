...
var connectionstring = builder.Configuration.GetConnectionString("ReviewDb");
builder.Services.AddDbContext<ReviewDbContext>(options=>options.UseSqlServer(connectionstring));
...
builder.Services.AddScoped<IReviewRepository, ReviewReposiotry>();
